...
class GptConfig:
    ...
    def from_dict(self, config_dict):
        ...
        self.output_percentage = config_dict.get("output_percentage", self.output_percentage)
        self.prompt_percentage = config_dict.get("prompt_percentage", self.prompt_percentage)
